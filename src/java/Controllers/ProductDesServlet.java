...
public class ProductDesServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProductDesServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ProductDesServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Products> rela = DAO_Products.INSTANCE.loadProduct(str2);
        ...
        request.getRequestDispatcher("ProductDes.jsp").forward(request, response);
        //processRequest(request, response);
    }
